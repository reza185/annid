...
(function($) {
	...
	if($('.owl-carousel.popular-mentor-slide').length > 0 ){
		var owl = $('.owl-carousel.popular-mentor-slide');
	      	owl.owlCarousel({
			rtl: true,
			items:4,
			margin:30,
	...
	$('.birthdate-picker').persianDatepicker({
		initialValue: false,
		format: "L",
	});
	// Chat
...
const now = new Date().toLocaleDateString("fa-IR", { year: "numeric" })

footerDate.innerHTML = now