...
(function($) {
    ...
    $(document).on("click",".add-links",function () {
		var experiencecontent = '<div class="links-cont">' +
			'<div class="service-amount">' +
				'<a href="#" class="service-trash"><i class="feather-minus-circle me-1"></i> هزینه خدمات</a> <span>14,000 تومانءءء</span' +
			'</div>' +
		'</div>';
    ...
    $(document).on("click",".add-links-one",function () {
		var experiencecontent = '<div class="links-cont-discount">' +
			'<div class="service-amount">' +
				'<a href="#" class="service-trash-one"><i class="feather-minus-circle me-1"></i> پیشنهاد جدید</a> <span>14 %</span' +
			'</div>' +
		'</div>';
